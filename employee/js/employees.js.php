    ...
    function jumpToPage() {
      ...
      const totalPages = <?php echo intval($_GET['totalPages'] ?? 1); ?>;
      const currentView = '<?php echo htmlspecialchars($_GET['currentView'] ?? 'list'); ?>';
      const perPage = <?php echo intval($_GET['perPage'] ?? 10); ?>;
      
      if (isNaN(page) || page < 1 || page > totalPages) {
        pageInput.value = <?php echo intval($_GET['page'] ?? 1); ?>;
