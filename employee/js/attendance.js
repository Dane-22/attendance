        ...
        html += `
          <div class="employee-card-list" id="employee-${employee.id}">
            <div class="employee-info">
              <div class="employee-name">${employee.name} <span class="employee-code">(${employee.employee_code})</span></div>
              <div class="employee-position">${employee.position} | Branch: Not Assigned</div>
              ${branchHistory}
            </div>
