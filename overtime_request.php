 ...
 * 
 * Parameters:
 * - employee_id (int, required): Employee's database ID
 * - employee_code (string, required): Employee's unique code
 * - branch_name (string, required): Employee's assigned branch
 * - requested_hours (decimal, required): Number of overtime hours (max 4)
 * - overtime_reason (text, required): Reason for requesting overtime
 * 
 * Response: JSON { success: boolean, message: string, request_id?: int }
 */
